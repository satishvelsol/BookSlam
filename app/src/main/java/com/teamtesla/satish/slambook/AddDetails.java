                ...
                call.enqueue(new Callback<MSG>() {
                    ...
                    public void onResponse(Call<MSG> call, Response<MSG> response) {
                        if (response.body().getSuccess() == 0) {
                            ...
                            Intent adddetails_success_push = new Intent(AddDetails.this, Home.class);
                            startActivity(adddetails_success_push);
                        } else if (response.body().getSuccess() == 2) {
                            mMobile_et.setError(response.body().getMessage());
                            mMobile_et.setFocusable(true);
                        } else {
                            Toast.makeText(AddDetails.this, "" + response.body().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailure(Call<MSG> call, Throwable t) {
                        Toast.makeText(AddDetails.this, "Oops..! Something went Wrong", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }
